...
def simulate_outcome(
    ...
    baseline_drift = gen_baseline_drift(
    ...
    for dependency in dependencies:
        if dependency in treatments:
            ...
            underlying_state += (
                ...
                * causal_effects["{} -> {}".format(dependency, outcome_params["name"])]
            )
    ...
    # Observation
    observation = [
        round(u + np.random.normal(0, outcome_params["sigma_0"]))
...
def simulate_treatment(
    study_design, days_per_period, treatment, dependencies, params, causal_effects, data
):
    """
    ...
    return treatment_arr[-days_per_period:], treatment_effects_array[-days_per_period:]
...
def simulate_node(
    node, dependencies, length, data, params, causal_effects, over_time_effects=None
):
    """
